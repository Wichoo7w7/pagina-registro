...
let AuditLog = class AuditLog extends BaseEntityWithTimestamps_1.BaseEntityWithTimestamps {
};
...
exports.AuditLog = AuditLog = __decorate([
    ...
    (0, typeorm_1.Index)('IDX_audit_entity_action', ['entity', 'action']),
    (0, typeorm_1.Index)('IDX_audit_user', ['performedBy'])
], AuditLog);
