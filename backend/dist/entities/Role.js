...
let Role = class Role extends BaseEntityWithTimestamps_1.BaseEntityWithTimestamps {
};
exports.Role = Role;
__decorate([
...
__decorate([
    (0, typeorm_1.OneToMany)(() => User_1.User, (user) => user.roles),
    __metadata("design:type", Array)
], Role.prototype, "users", void 0);
exports.Role = Role = __decorate([
    (0, typeorm_1.Entity)('roles'),
    (0, typeorm_1.Index)('UQ_role_name', ['name'], { unique: true })
], Role);
